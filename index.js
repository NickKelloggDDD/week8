...
// check to see if user is logged-in (i.e. user exists), only do the stuff if logged in)
if (user) {
   ...
   for (let j=0; j < post.comments.length; j++) {
    ...
    <div class="md:mt-16 mt-8">
      <div class="md:mx-0 mx-4 mt-8">
        <span class="font-bold text-xl">Anonymous User</span>
      </div>
      <div class="my-8">
